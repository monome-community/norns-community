---
title: Orca
description: a visual programming language, designed to create procedural sequencers on the fly
published: true
date: 2021-09-15T17:40:39.889Z
tags: delays + loopers, sequencers, crow, grid, arc, keyboard, midi, generative
editor: markdown
dateCreated: 2021-03-30T16:19:03.880Z
---

![orca.png](/community/collabs/orca.png)

initialized by [@its_your_bedtime](https://llllllll.co/u/its_your_bedtime)
further developed by [@Frederickk](/authors/frederickk)
...
![Norns Maiden update Community feed](https://github.com/itsyourbedtime/orca/raw/master/.assets/orca-maiden.png)
...
- *`playhead`*
  - values: `0` – `6`: index of voice (buffer)
- *`rec`*
...
![Convert Orca to/from .txt, .json, .orca,100%](https://github.com/itsyourbedtime/orca/raw/master/.assets/orca-convert.png)
