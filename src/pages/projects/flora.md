...
authors:
 - jaseknighter
redirect_from:
 - /en/authors/jaseknighter/flora
 - /authors/jaseknighter/flora
---
![](https://raw.githubusercontent.com/jaseknighter/flora/HEAD/images/three_plants_inv.png)
...
![](https://raw.githubusercontent.com/jaseknighter/flora/HEAD/images/three_more_plants_inv.png)
...
#### Plant 
![](https://raw.githubusercontent.com/jaseknighter/flora/HEAD/images/plant_wide_inv.png)
```
e1: next page  
...
#### Modify 
![](https://raw.githubusercontent.com/jaseknighter/flora/HEAD/images/modify_wide_inv.png)
```
...
#### Observe 
![](https://raw.githubusercontent.com/jaseknighter/flora/HEAD/images/observe_wide_inv.png)
```
e1: next/previous page  
k1 + e1: select active plant  
e2: move up/down  
...
#### Plow 
![](https://raw.githubusercontent.com/jaseknighter/flora/HEAD/images/plow_wide_inv.png)
```
e1: next/previous page 
k1 + e1: select active plant  
...
#### Water 
![](https://raw.githubusercontent.com/jaseknighter/flora/HEAD/images/water_wide_inv.png)
```
e1: next/previous page  
e2: select control  
...
![](https://raw.githubusercontent.com/jaseknighter/flora/HEAD/images/tinta_wide_inv.png)
```
e1: previous page  
...
![](https://raw.githubusercontent.com/jaseknighter/flora/HEAD/images/tinta_env_wide_inv.png)
...
![](https://raw.githubusercontent.com/jaseknighter/flora/HEAD/images/yet_three_more_plants_inv.png)
